...
import { ShieldCheck, CheckCircle2, Clock, Layers } from 'lucide-react';
import { Link } from 'react-router-dom';

const BackglassReplacement: React.FC = () => {
  return (
    <div className="bg-brand-light min-h-screen">
      {/* Hero Section */}
      <section className="bg-brand-dark text-white py-24 px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?q=80&w=2000&auto=format&fit=crop" alt="Backglass Replacement" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-7xl mx-auto z-10 text-center">
          <div className="mb-4 inline-flex items-center gap-2 bg-brand-primary/20 text-brand-primary font-bold px-4 py-2 rounded-full border border-brand-primary/30">
             <Layers className="h-5 w-5" /> Expert Mobile Replacement
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6">Backglass Replacement</h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10">
            Rear windshield shattered? We provide complete mobile replacements, including defrost grid connections and thorough glass cleanup.
          </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-brand-dark">Complete Rear Windshield Care</h2>
              <p className="text-lg text-gray-600 mb-6">
                When a rear windshield breaks, it typically shatters completely because it is made of tempered glass. This leaves your vehicle open to the elements and requires meticulous cleanup.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our expert technicians not only install the new backglass perfectly, but they also ensure any embedded defrost grids and antenna technologies are properly connected and functioning.
              </p>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mb-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <span className="font-bold text-gray-800">Defrost Grid Connection</span>
                      <p className="text-gray-600 text-sm">We ensure your rear defroster works perfectly.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-6 w-6 text-brand-primary mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-bold text-gray-800">Thorough Vacuuming</span>
                      <p className="text-gray-600 text-sm">We meticulously clean all broken glass from your interior and trunk.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">We perform the replacement safely in your driveway or parking lot.</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-gray-100 rounded-2xl h-full min-h-[400px] relative overflow-hidden flex items-center justify-center border border-gray-200">
               <Layers className="h-24 w-24 text-gray-300" />
            </div>
          </div>
        </div>
      </section>
...
export default BackglassReplacement;
